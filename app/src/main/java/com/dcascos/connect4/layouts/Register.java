...
import com.dcascos.connect4.fragments.QueryFrag;

public class Register extends AppCompatActivity implements QueryFrag.OnItemSelectedListener {
	...
	public void onItemSelected(long id) {
		...
		if (queryDetailFrag != null && queryDetailFrag.isInLayout()) {
			...
			Intent intent = new Intent(this, QueryDetail.class);
